...
public class LazyViewPager extends ViewGroup {
    ...
    private static final int DEFAULT_OFFSCREEN_PAGES = 0;//默认的加载页面,ViewPager是1个,所以会加载两个界面
    private static final int MAX_SETTLE_DURATION = 600; // msandroid-support-v4.jar
